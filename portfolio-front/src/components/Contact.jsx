...
export default function Contact() {
  ...
  const contactDetails = [
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#0A66C2" style={{ display: 'block' }}>
          ...
          <div className="contact-info">
            {contactDetails.map((detail, index) => (
              <a
                ...
                className="contact-card contact-info-card glass reveal"
